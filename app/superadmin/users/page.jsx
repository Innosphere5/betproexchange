              ...
              <div className="grid grid-cols-4 gap-0 border border-gray-200 bg-white text-center">
                ...
                <div className="p-3 border-r border-gray-200">
                  ...
                  <p className="text-[13px] font-bold text-blue-600 mt-1">
                    {activeTab === 'cash' 
                      ? `${selectedUser?.walletBalance?.toLocaleString()} Rs.` 
          ...
          <div className="bg-white border border-gray-300 shadow-sm rounded-sm overflow-hidden flex flex-col">
            ...
            <div className="border-b border-gray-200">
              <table className="w-full text-sm font-bold text-left">
                ...
                <tbody>
                  <tr>
                    <td className="px-4 py-3 text-green-700">{users.reduce((sum, u) => sum + (u.credit || 0), 0).toLocaleString()}</td>
                    <td className="px-4 py-3 text-green-700">{users.reduce((sum, u) => sum + (u.walletBalance || 0), 0).toLocaleString()}</td>
                  ...
                  {isLoading ? (
                    ...
                    users.map((item) => (
                      <tr key={item._id} className="border-b hover:bg-gray-50 transition-colors text-gray-700 font-medium">
                        ...
                        <td className="px-4 py-2 border-r font-bold text-gray-600">{item.credit?.toLocaleString() || 0}</td>
