...
import BetControl from "../../../components/aviator/BetControl";
import HistoryStrip from "../../../components/aviator/HistoryStrip";
import ProvablyFairModal from "../../../components/aviator/ProvablyFairModal";
...
export default function AviatorPage() {
  ...
  useEffect(() => {
    ...
    socket.on('aviator_round_reset', handleRoundReset);
    ...
    return () => {
      ...
      socket.off('aviator_round_reset', handleRoundReset);
    };
  }, [socket, joined]);
    ...
    <div className="min-h-screen bg-[#0c1520] text-white flex flex-col p-4 space-y-4">
      ...
      <div className="flex items-center justify-between bg-[#101b26] border border-white/5 px-4 py-2.5 rounded-2xl shadow-lg shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-sm font-black tracking-tight uppercase leading-none">Aviator</h1>
          ...
          {activeTab === 'rules' && (
            <div className="bg-[#101b26] border border-white/5 rounded-2xl p-6 flex flex-col space-y-6 flex-1 text-gray-300 animate-in fade-in duration-300 text-sm overflow-y-auto">
              <div className="border-b border-white/5 pb-2">
                <h3 className="text-md font-black uppercase text-white tracking-wider">How to Play Aviator</h3>
              </div>
