...
export default function MasterCurrentPosition() {
    ...
    <div className="flex flex-col gap-4 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex items-center justify-between bg-white p-3 border border-gray-300 rounded-sm shadow-sm">
        <div className="flex items-center gap-2">
          <Trophy size={20} className="text-[#f39c12]" />
          <h1 className="text-lg font-bold text-gray-800 uppercase tracking-tight">Current Position</h1>
        </div>
        <button
          onClick={fetchData}
          disabled={isLoading}
          className="bg-[#f39c12] hover:bg-orange-600 text-white px-3 py-1.5 rounded-sm flex items-center gap-2 text-sm font-semibold transition-all shadow-sm disabled:opacity-50"
        >
      ...
      <div className="bg-white border border-gray-300 shadow-sm rounded-sm overflow-hidden">
        <div className="bg-[#f2f2f2] border-b border-gray-300 px-3 py-2.5 flex items-center justify-between font-bold text-gray-800 text-[13px]">
          <div className="flex items-center gap-2">
            <Filter size={16} className="text-[#f39c12]" />
            Market Highlights
          </div>
          <span className="bg-orange-50 text-orange-700 text-[10px] font-bold px-2 py-0.5 rounded-full border border-orange-200 uppercase tracking-tighter">Live Position</span>
        </div>
