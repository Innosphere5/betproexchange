  ...
  return (
    <div className="flex flex-col gap-4 max-w-full min-h-[calc(100vh-120px)] flex-grow">
        ...
        <div className="p-6 flex items-center gap-4 flex-wrap">
          ...
          <div className="flex items-center">
            <input 
              ...
              className="border border-gray-300 border-r-0 px-3 py-1.5 focus:outline-none focus:border-[#f39c12] w-[200px] text-sm text-gray-700"
            />
          ...
          <button className="bg-[#f39c12] hover:bg-orange-600 text-white px-4 py-1.5 text-sm font-semibold rounded-sm transition-colors">
            Submit
          </button>
        </div>
      </div>
      ...
      <div className="text-gray-800 text-sm font-bold mt-auto mb-4 self-center flex items-center justify-center w-full max-w-2xl px-6">
        <span className="mr-auto w-full max-w-[200px] translate-x-[400px]">Welcome to Broker Panel.</span>
      </div>
    </div>
  );
}
