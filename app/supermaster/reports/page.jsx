...
export default function SuperMasterReports() {
            ...
            <div className="p-4">
              ...
              <div className="border border-gray-200">
                <table className="w-full text-[12px]">
                  ...
                  <tfoot>
                    <tr className="bg-[#f39c12] text-white font-black text-sm">
  ...
  return (
    <div className="flex flex-col gap-4 max-w-full pb-10">
          ...
          {reportTypes.map(btn => (
            <button 
              ...
              className={`px-3 py-1.5 text-[12px] font-bold rounded-sm shadow-sm transition-all border ${
                ...
                : 'bg-white border-gray-300 text-gray-700 hover:border-[#f39c12] hover:text-[#f39c12]'
              }`}
            >
              {btn}
            </button>
      ...
      <div className="text-gray-500 text-[11px] font-bold mt-4 self-center italic text-center w-full">
        Welcome to Betproexchange SuperMaster Portal.
      </div>
    </div>
  );
}
