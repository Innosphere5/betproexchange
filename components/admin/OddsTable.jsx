...
export default function OddsTable({ title, runners, lastUpdated, remainingTime }) {
  return (
    <div className="bg-white rounded-sm shadow-sm overflow-hidden border border-gray-200 mb-4">
      ...
      {remainingTime && (
        <div className="flex justify-end px-3 py-1 bg-[#f8f9fa] border-b border-gray-200">
          <span className="text-[11px] font-bold text-gray-600">Remaining: <span className="text-gray-900">{remainingTime}</span></span>
        </div>
      )}
